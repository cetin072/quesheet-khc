(()=>{
  ...
  let state={data:null,view:'home',eventId:null,stepId:null,runIndex:0,runActiveSteps:[],fontIndex:1,vibration:true,lastSaved:null,saveError:false,searchOpen:false,query:'',filter:'all',statusFilter:'all',sort:'dday'};
  ...
  document.addEventListener('keydown',event=>{if(event.key==='Escape'&&state.view==='home'&&state.searchOpen){state.searchOpen=false;renderHome();}});
  load();render();
})();
