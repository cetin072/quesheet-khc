(()=>{
  ...
  const seedData=()=>({version:APP_VERSION,events:[
    ...
    {id:uid(),templateKey:'taejang-opening-20260812',templateRevision:5,type:'개소식',status:'준비 완료',title:'농업회사법인 태장 주식회사 개소식',date:'2026-08-12',time:'15:00',location:'창원 신화더플렉스시티 태장㈜ 사업장',host:'○○○',notes:taejangOpeningNotes,steps:withIds(openingSteps),createdAt:Date.now(),updatedAt:Date.now()}
  ],trash:[]});
  ...
  const isLegacyTaejangOpening=e=>e&&e.title==='농업회사법인 태장 주식회사 개소식'&&e.date==='2026-08-12'&&Array.isArray(e.steps)&&(
    (e.templateKey==='taejang-opening-20260812'&&e.templateRevision!==5)||
  ...
  const migrateData=data=>{
    ...
    data.events=data.events.map(e=>{
      ...
      if(isLegacyTaejangOpening(e)){
        changed=true;
        return {...e,templateKey:'taejang-opening-20260812',templateRevision:5,type:'개소식',status:'준비 완료',title:'농업회사법인 태장 주식회사 개소식',date:'2026-08-12',time:'15:00',location:'창원 신화더플렉스시티 태장㈜ 사업장',host:e.host||'○○○',notes:taejangOpeningNotes,steps:withIds(openingSteps),updatedAt:Date.now()};
      }
      return e;
    });
    return changed;
