...
for (const marker of ['id="optionsBtn"','id="searchToggle"','id="searchPanel"']) {
  if (!dom.includes(marker)) throw new Error(`UAR_SMOKE_DYNAMIC_HOME_MARKER_MISSING:${marker}`);
}
...
console.log(`UAR_REPRESENTATIVE_SMOKE_PASS chrome=${chrome} preview_assets=true dynamic_home=true`);
